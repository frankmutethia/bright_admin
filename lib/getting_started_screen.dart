...
final slideList = [
  Slide(
    imageUrl: 'assets/images/45551-men-relaxing-on-working-chair.gif',
    title: 'Welcome to Bright Care Admin Panel.',
    description: 'We help you to keep going.',
  ),
  Slide(
    imageUrl: 'assets/images/43098-video-conference-icon.gif',
    title: 'Keep a positive state of mind.',
    description: 'Your security is our priority.',
  ),
  Slide(
    imageUrl: 'assets/images/34705-lock-cpu-cyber-security.gif',
    title: 'Stay positive.',
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isActive ? Theme.of(context).primaryColor : Colors.purple,
